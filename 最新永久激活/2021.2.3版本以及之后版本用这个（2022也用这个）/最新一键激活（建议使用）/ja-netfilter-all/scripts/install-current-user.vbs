...
aJBProducts = Array("idea", "webstorm", "pycharm", "clion", "phpstorm", "goland", "datagrip", "webide", "rider", "rubymine", "appcode", "dataspell", "gateway", "jetbrains_client", "jetbrainsclient", "studio", "devecostudio")
