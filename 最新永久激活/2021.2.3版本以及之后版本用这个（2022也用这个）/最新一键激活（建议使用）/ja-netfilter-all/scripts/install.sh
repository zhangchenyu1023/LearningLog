...
OS_NAME=$(uname -s)
JB_PRODUCTS="idea clion phpstorm goland pycharm webstorm datagrip webide rider rubymine appcode dataspell gateway jetbrains_client jetbrainsclient studio devecostudio"
